...
public class deleteProject {
    ...
    public void the_user_is_the_manager_of_the_project() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @Given("the user is not the manager of the project")
    public void the_user_is_not_the_manager_of_the_project() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
